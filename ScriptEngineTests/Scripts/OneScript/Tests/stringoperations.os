...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ВызватьМетод_СтрНачинаетсяС_НаЛатинице_Устаревший");
	...
	ВсеТесты.Добавить("ТестДолжен_Проверить_Что_НСТР_БезПараметра_ВозвращаетПервуюСтроку");
...
Процедура ТестДолжен_ВызватьМетод_СтрНачинаетсяС_НаЛатинице_Устаревший() Экспорт
	//arrange	
	//act
...
Процедура ТестДолжен_Проверить_Что_НСТР_БезПараметра_ВозвращаетПервуюСтроку() Экспорт
	
	Стр = НСтр("ru = 'Строка1'; en = 'Строка2'");
